...
var historia = document.getElementsByClassName('btn')[1]
historia.addEventListener ("click", function() {
    open('https://www.google.com')
})

var regras = document.getElementsByClassName('btn')[2]
regras.addEventListener ("click", function() {
    open('https://www.google.com')
})

var discord = document.getElementsByClassName('btn')[3]
discord.addEventListener ("click", function() {
    open('https://www.google.com')
  });

var loja = document.getElementsByClassName('btn')[4]
loja.addEventListener ("click", function() {
      open('https://www.google.com')
  })


var streamer = document.getElementsByClassName('btn')[5]
...
var audio = new Audio('soundumbrella.mp3')
audio.play()
audio.volume = 0.1;
